...
define config.name = _("Remember.역행하는 별의 기적")
...
define config.main_menu_music = "audio/mainbackgroundmusic.mp3"
...
define config.save_directory = "GSHS-1627354287"
